...
function memberSince(createdAt?: string | null) {
    ...
    const months = Math.max(1, Math.round((Date.now() - d.getTime()) / (30 * 24 * 3600 * 1000)));
                    ...
                    >
                        ...
                        <View style={styles.statsContainer}>
                            <View style={styles.statCard}>
                                <Text style={styles.statValue}>{profile?.tripsCount ?? 0}</Text>
                        ...
                        <View style={styles.section}>
                            ...
                            <View style={styles.menuContainer}>
                                <MenuItem
                                    icon="car-outline"
                                    label="Truck Details"
                                    subLabel={profile?.truckType
                                        ? `${profile.truckType}${profile.truckNumber ? ` · ${profile.truckNumber}` : ''}`
                                        : 'Set truck type & number'}
                                    onPress={() => router.push('/driver/truck-details' as any)}
                                />
                                <MenuItem
                                    icon="document-text-outline"
                                    label="Documents"
                                    subLabel={profile?.verificationStatus === 'approved'
                                        ? 'Verified — view uploads'
                        ...
                        <View style={styles.section}>
                            ...
                            <View style={styles.menuContainer}>
                                <MenuItem
                                    ...
                                    color="#10B981"
                                    showDivider={false}
                                    onPress={() => router.push('/driver/bank-account' as any)}
                                />
                                <MenuItem
                                    icon="wallet-outline"
                                    label="Wallet & Earnings"
                                    subLabel="Balance, withdraw, history"
                                    color={primary}
                                    showDivider={false}
