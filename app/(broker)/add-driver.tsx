...
const VEHICLE_TYPES = [
    { id: 'mini', name: 'Mini Truck', capacity: '1.5 Tons', icon: 'car-outline' },
    { id: 'pickup', name: 'Pickup Truck', capacity: '3 Tons', icon: 'car-sport-outline' },
    { id: 'container', name: 'Container', capacity: '8 Tons', icon: 'bus-outline' },
];
...
export default function AddDriver() {
    ...
    const handleAddDriver = () => {
        if (!name || !phone || !vehicleNumber || !licenseNumber) {
            Alert.alert('Missing Info', 'Please fill in all details to add the driver.');
            return;
        }
        ...
        setTimeout(() => {
            ...
            Alert.alert(
                'Driver Added',
                `${name} has been successfully added to your driver network.`,
                [
                    {
                        text: 'OK',
                        onPress: () => router.back(),
