...
const MOCK_DRIVERS = [
    ...
    },
    {
        ...
        vehicleNumber: 'MH 12 QP 1122',
        rating: 4.9,
        tripsCount: 92,
        status: 'busy', // MH 12 QP 1122 is busy on trip #TRK-1002
    },
    {
        id: '3',
        name: 'Vikram Singh',
    ...
    },
    {
        ...
        rating: 4.7,
        tripsCount: 88,
        status: 'active', // 'active' represents 'online' availability
    },
    {
        id: '5',
        name: 'Suresh Patel',
...
export default function DriverNetwork() {
    ...
    const renderDriverItem = ({ item }: { item: typeof MOCK_DRIVERS[0] }) => (
            ...
            >
                <View style={styles.cardHeader}>
                    <View style={styles.driverMeta}>
                        ...
                        <Text style={styles.vehicleInfo}>{item.vehicleType} • {item.vehicleNumber}</Text>
                    </View>
