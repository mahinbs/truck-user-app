                ...
                >
                            ...
                            >
                                ...
                                >
                                    <BlurView intensity={30} tint="light" style={styles.statBlur}>
                                        ...
                                        <Text style={[styles.statValue, { color: '#F59E0B' }]}>₹5,450</Text>
                    ...
                    >
                        <View style={styles.section}>
                            ...
                            <TouchableOpacity
                                activeOpacity={0.9}
                                onPress={() => handleTrackTrip('active-1')}
                                ...
                                >
                                    <BlurView intensity={35} tint="light" style={styles.tripBlur}>
                                        <View style={styles.tripHeader}>
                                            <View>
                                                <Text style={styles.tripRoute}>Mumbai → Bangalore</Text>
                                                <Text style={styles.tripIdText}>Trip ID: #TRK-1002</Text>
                                            </View>
                                        ...
                                        <View style={styles.progressSection}>
                                            <View style={styles.progressInfo}>
                                                <Text style={styles.progressLabel}>Completed Distance</Text>
                                        ...
                                        <View style={styles.tripDetails}>
                                            <View style={styles.detailItem}>
                                                <Ionicons name="person-circle" size={16} color={primary} />
                                                <Text style={styles.detailText}>Amit Sharma</Text>
                                            </View>
                                            <View style={styles.detailItem}>
                                                <Ionicons name="car-outline" size={16} color="#10B981" />
                                                <Text style={styles.detailText}>Tata Ace (MH-12-QP-1122)</Text>
                                            </View>
                                        </View>

                                        <View style={styles.tripFooter}>
                                            <Text style={styles.tripCommissionText}>Commission: <Text style={styles.highlightText}>₹600</Text></Text>
                            ...
                            <TouchableOpacity
                                activeOpacity={0.9}
                                onPress={() => handleTrackTrip('active-2')}
                                style={styles.tripCardWrapper}
                            >
                                <LinearGradient
                                    colors={['rgba(59, 130, 246, 0.08)', 'rgba(96, 165, 250, 0.04)']}
                                ...
                                >
                                    <BlurView intensity={35} tint="light" style={styles.tripBlur}>
                                        <View style={styles.tripHeader}>
                                            <View>
                                                <Text style={styles.tripRoute}>Pune → Delhi</Text>
                                                <Text style={styles.tripIdText}>Trip ID: #TRK-1005</Text>
                                            </View>
                                        ...
                                        <View style={styles.tripDetails}>
                                            <View style={styles.detailItem}>
                                                <Ionicons name="person-circle" size={16} color={primary} />
                                                <Text style={styles.detailText}>Vikram Singh</Text>
                                            </View>
                                            <View style={styles.detailItem}>
                                                <Ionicons name="car-outline" size={16} color="#10B981" />
                                                <Text style={styles.detailText}>Mahindra Bolero (MH-14-AA-9988)</Text>
                                            </View>
                                        </View>

                                        <View style={styles.tripFooter}>
                                            <Text style={styles.tripCommissionText}>Commission: <Text style={styles.highlightText}>₹1,050</Text></Text>
                                            <View style={styles.trackButton}>
                                                <Text style={styles.trackButtonText}>Track Live</Text>
                                                <Ionicons name="arrow-forward" size={14} color={primary} />
                                            </View>
