                                ...
                                <View style={styles.infoRow}>
                                    <View style={styles.infoItem}>
                                        ...
                                        <View>
                                            ...
                                            <Text style={styles.infoValue}>Container Truck</Text>
                                        </View>
                                    </View>
                        ...
                        <View style={styles.card}>
                            <View style={styles.locationHeader}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.lastUpdate}>Updated 2 mins ago</Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.currentLocation}>
                                ...
                                <View style={styles.currentLocationText}>
                                    ...
                                    <Text style={styles.currentLocationValue}>Vadodara, Gujarat</Text>
                                </View>
                            </View>
                        </View>
